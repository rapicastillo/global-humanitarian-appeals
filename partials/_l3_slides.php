 <div style="position: relative" id="l3-slideshows">
    ...
    >
      ...
      <!-- Facts -->
      <div class="fact-item" style="bottom: 200px;">
        <span class="fact-number" data-count="6.4" data-final="6.4" data-nth="M">0</span>
        <span class="data-icon"><img src="images/icons/white-affected.png" /></span>
        <span>People in need</span>
      </div>
      <div class="fact-item" style="bottom: 100px;">
    ...
    >
      ...
      <!-- Facts -->
      <div class="fact-item" style="bottom: 200px;">
        <span class="fact-number" data-count="2.7" data-final="2.7" data-nth="M">0</span>
        <span class="data-icon"><img src="images/icons/white-affected.png" /></span>
        <span>People in need</span>
      </div>
      <div class="fact-item" style="bottom: 100px;">
        <span class="fact-number" data-count="430" data-final="430" data-nth="K">0</span>
        <span class="data-icon"><img src="images/icons/white-displaced.png" /></span>
        <span>Internally Displaced People</span>
      </div>
      ...
      data-bottom-center="..." data-top-bottom="..." data-emit-events>
        ...
        <!-- Facts -->
        <div class="fact-item" style="bottom: 200px;">
          <span class="fact-number" data-count="5.2" data-final="5.2" data-nth="M">0</span>
          <span class="data-icon"><img src="images/icons/white-affected.png" /></span>
          <span>People in need</span>
        </div>
        <div class="fact-item" style="bottom: 100px;">
